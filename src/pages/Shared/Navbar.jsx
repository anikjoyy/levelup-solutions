...
import Icon from '../../assets/level.png';
        ...
        <div className={`${open ? null : 'hidden'} h-[19rem]`}>
          ...
          <div className='bg-gray-200/50 h-[1px] w-[85%] ml-[-10px]'>
            <div className='flex cursor-pointer'>
              ...
              />
              <p className='my-auto ml-4 text-white font-semibold'>Anik</p>
              <p className='my-auto ml-2 text-white font-semibold'>Joy</p>
            </div>
            <p className='my-auto ml-[103px] mt-[-27px] text-xs font-light text-gray-200/60'>
              anikjoy.cse@gmail.com
            </p>
          </div>
